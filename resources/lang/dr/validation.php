...
return array(
    ...
    */
    'attributes' => array(
        ...
        "fullname" => "نام مکمل",
        "fathername" => "مختصر پرسش",
        "question" => "پرسش",
        "suggest_name" => "نام مکمل",
        "suggest_phone" => "نمبر موبایل",
        "suggest_email" => "پست الکترونیکی",
        "suggest_desc" => "پیشنهاد",
        "answer" => "جواب",
        "answerby" => "جواب مختصر",
        "scholar_name" => "نام مکمل",
        "scholar_self_desc" => "درباره عالم",
        "artical_name" => "نام مقاله",
        "artical_desc" => "درباره مقاله",
        "artical_source" => "منبع مقالی",
        "info_desc" => "اضافه نمودن معلومات",
